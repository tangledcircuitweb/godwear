  ...
  return c.render(
    <div>
      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        <ul>
          <li>
            <a href="/api/example">API Example</a> - Test KV and D1 bindings
          </li>
          <li>
            <a href="https://developers.cloudflare.com/workers/">Cloudflare Workers Docs</a>
          </li>
          <li>
            <a href="https://github.com/honojs/honox">HonoX GitHub</a>
          </li>
        </ul>
      </div>
