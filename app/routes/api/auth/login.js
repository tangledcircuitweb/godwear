...
export default createRoute(async (c) => {
    ...
    try {
        ...
        if (!(env.GOOGLE_CLIENT_ID && env.GOOGLE_CLIENT_SECRET)) {
            const errorResponse = createErrorResponse(ErrorCodes.SERVICE_CONFIGURATION_ERROR, "OAuth configuration not available", undefined, "auth-login");
        ...
        const errorResponse = createErrorResponse(ErrorCodes.INTERNAL_SERVER_ERROR, "Failed to initiate login", {
