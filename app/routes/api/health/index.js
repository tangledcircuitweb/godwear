...
import { createErrorResponse, createHealthResponse, ErrorCodes, } from "../../../../types/api-responses";
...
export default createRoute(async (c) => {
    ...
    try {
        ...
        const healthResponse = createHealthResponse("godwear-api", systemHealth.overall, systemHealth.dependencies, "1.0.0");
        // Return appropriate HTTP status code
        const httpStatus = systemHealth.overall === "healthy" ? 200 : systemHealth.overall === "degraded" ? 200 : 503;
