 ...
 */
export function createUnion(options) {
 ...
 */
export function createDiscriminatedUnion(discriminator, options) {
    // Use type assertion to make TypeScript happy
 ...
 */
export function createApiResponseSchema(dataSchema, options = {}) {
 ...
 */
export function createStrictObject(shape) {
    return z.object(shape).strict();
}
export function createPassthroughObject(shape) {
 ...
 */
export function createStringWithErrorMessage(message) {
    return z.string({ error: message });
}
export function createNumberWithErrorMessage(message) {
