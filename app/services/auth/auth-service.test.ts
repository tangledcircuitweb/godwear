...
import { createMockEnv, server } from "../../../tests/live/setup";
...
describe("AuthService", () => {
  ...
  describe("verifyJWT", () => {
    ...
    it("should reject expired JWT token", async () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.error).toMatch(/expired|invalid/i); // More flexible error matching
    });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle missing environment variables", () => {
      ...
      incompleteEnv.JWT_SECRET = undefined;
