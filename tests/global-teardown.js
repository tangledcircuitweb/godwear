  ...
  try {
    ...
    for (const bucketName of bucketNames) {
      try {
        ...
        console.warn(`  ⚠️  Failed to delete R2 bucket ${bucketName}:`, error.message);
      }
    }
  } catch (error) {
  ...
  try {
    ...
    for (const namespace of testNamespaces) {
      try {
        ...
        console.warn(`  ⚠️  Failed to delete KV namespace ${namespace.title}:`, error.message);
      }
    }
  } catch (error) {
  ...
  try {
    ...
    for (const database of testDatabases) {
      try {
        ...
        console.warn(`  ⚠️  Failed to delete D1 database ${database.name}:`, error.message);
      }
    }
  } catch (error) {
